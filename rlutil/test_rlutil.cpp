...
int main() {
  ...
  std::cout << "(8,8)";
  std::cout << std::endl
            << "You should see three coordinates in their specified locations." << std::endl;
  waitkey;
  ...
  std::cout << "Next numbers should appear rapidly after each other (but not instantly)."
            << std::endl;
  rlutil::msleep(500);
  ...
  std::cout << "You should see the size in character rows and columns of your terminal window."
            << std::endl;
  ...
  std::cout << "Next ASCII characters should appear rapidly after each other in the same position."
            << std::endl;
  {
  ...
  std::cout << "Next random character strings should appear rapidly after each other starting in "
               "the same position."
            << std::endl;
  {
